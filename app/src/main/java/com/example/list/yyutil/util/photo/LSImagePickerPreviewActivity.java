...
//    private LSImagePickerPreviewAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new PhotoImageGralleryAdapter(this, totalUris);
...
//      如果是编辑页面进来， 不展示
        ...
        if ( isEdit )
        {
            okButton.setBackgroundResource(R.drawable.dynamic_preview_icon_delet);
            okButton.setText("");
        }
...
//                ToastUtil.getInstance().showSelectImage9Toast(this, com.lis99.mobile.club
//                        .LSImagePicker.MAX_COUNT+"");
                return;
            }
    ...
    private void resetButton(){
        ...
        if (selectedUris.size() > 0) {
            ...
            okButton.setText("下一步(" + selectedUris.size() + ")");
